...
#define CONFIG_BOOTARGS		"mem=64M console=ttySAC0,115200n8 noinitrd  root=/dev/mtdblock3 rootfstype=yaffs rw"
...
#define CONFIG_BOOTCOMMAND	"nboot 0x30008000 0 0x80000;bootm 0x30008000"
